...
@interface RgGreenViewController ()

@end

@implementation RgGreenViewController
...
- (void)buttons {
    ...
    [get setTitle:@"获取当前window" forState:UIControlStateNormal];
...
- (void)getAction:(UIButton *)sender {
    ...
    NSLog(@"当前的 window 是 %@", [NSString stringWithUTF8String:object_getClassName(window)]);
